...
class TestVolkswagenMqbStockSafety(TestVolkswagenMqbSafetyBase):
  ...
  def test_cruise_status_4_5_engaged(self):
    ...
    for status in (4, 5):
      self._rx(self.packer.make_can_msg_safety("TSK_06", 0, {"TSK_Status": status}))
  ...
  def test_gra_acc_buttons_rx_stock(self):
    # with stock ACC, GRA_ACC_01 on rx takes the non-longitudinal path
