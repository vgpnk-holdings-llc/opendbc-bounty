...
static void toyota_rx_hook(const CANPacket_t *msg) {
  ...
  if (ADDR_BUS_MATCH(msg, 0x260U, 0U)) {
...
static bool toyota_tx_hook(const CANPacket_t *msg) {
  ...
  if (ADDR_BUS_MATCH(msg, 0x343U, 0U)) {
  ...
  if (ADDR_BUS_MATCH(msg, 0x183U, 0U)) {
    int desired_accel = (msg->data[0] << 8) | msg->data[1];
    desired_accel = to_signed(desired_accel, 16);
  ...
  if (ADDR_BUS_MATCH(msg, 0x283U, 0U)) {
  ...
  if (ADDR_BUS_MATCH(msg, 0x191U, 0U)) {
  ...
  if (toyota_secoc && ADDR_BUS_MATCH(msg, 0x131U, 0U)) {
  ...
  if (ADDR_BUS_MATCH(msg, 0x2E4U, 0U)) {
