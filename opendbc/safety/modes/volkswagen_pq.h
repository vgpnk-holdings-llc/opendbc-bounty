...
static void volkswagen_pq_rx_hook(const CANPacket_t *msg) {
  ...
  if (ADDR_BUS_MATCH(msg, MSG_BREMSE_1, 0U)) {
  ...
  if (ADDR_BUS_MATCH(msg, MSG_LENKHILFE_3, 0U)) {
  ...
  if (volkswagen_longitudinal) {
    if (ADDR_BUS_MATCH(msg, MSG_MOTOR_5, 0U)) {
    ...
    if (ADDR_BUS_MATCH(msg, MSG_GRA_NEU, 0U)) {
    ...
    if (ADDR_BUS_MATCH(msg, MSG_MOTOR_2, 0U)) {
  ...
  if (ADDR_BUS_MATCH(msg, MSG_MOTOR_3, 0U)) {
